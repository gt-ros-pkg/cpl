...
public:
  ...
  handsTracker ()
  {
    ...
    output_video.open("kinect_stuff.avi",CV_FOURCC('P','I','M','1'),12.0, img_of_interest.size());
    if(!output_video.isOpened()){cout<<"Cant Open Video";exit(-1);
