...
void kin_pc_sub(const sensor_msgs::PointCloud2::Ptr& msg)
{
...
int main(int argc, char **argv)
{
  ...
  ros::Subscriber<sensor_msgs::PointCloud2> kinect_pc_sub = hand_track_node.subscribe
    ("kinect0/depth_registered/points",  &kin_pc_sub);
