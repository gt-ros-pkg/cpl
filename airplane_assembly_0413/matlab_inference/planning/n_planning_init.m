...
plan1.events = struct( ...
            'signature', {111, 444}, ...
            'name', {'b1_6', 'Bin4'}, ...
            'sname', {'Remove Bin1', 'Add Bin4'}, ...
            'bin_id', {3, 14}, ...
            'location', {'L11', 'L26'}, ...
            'type', {'start_distribution', 'start_distribution'}, ...
            'cost_type', {'cost_earlyexpensive', 'cost_lateexpensive'}, ...
            'pre_duration', num2cell(int32(ones(1, 2) * 4 * 30 / m.params.downsample_ratio)), ...
            'post_duration', num2cell(int32(ones(1, 2) * 4 * 30 / m.params.downsample_ratio)));
