...
PERCEPTUAL_PROXIES = {CENTROID_CONTROLLER:[CENTROID_PROXY, SPHERE_PROXY, BOUNDING_BOX_XY_PROXY],
                      SPIN_COMPENSATION:[ELLIPSE_PROXY,BOUNDING_BOX_XY_PROXY],
                      DIRECT_GOAL_CONTROLLER:[CENTROID_PROXY, SPHERE_PROXY, CYLINDER_PROXY],
                      DIRECT_GOAL_GRIPPER_CONTROLLER:[CENTROID_PROXY, SPHERE_PROXY, CYLINDER_PROXY]}
