...
MPC_HOLD_OUT_SVR = MPC_CONTROLLER_PREFIX + CUR_OBJ
MPC_LOOKUP_SVR = MPC_CONTROLLER_PREFIX + 'shape_match'
MPC_CONTROLLER =  MPC_HOLD_OUT_SVR # MPC_NAIVE_LINEAR_DYN

SQP_LOOKUP_SVR = OPEN_LOOP_SQP_PREFIX + 'shape_match'
SQP_HOLD_OUT_SVR = OPEN_LOOP_SQP_PREFIX + CUR_OBJ
SQP_NAIVE_LINEAR_DYN = OPEN_LOOP_SQP_PREFIX + 'NAIVE_LINEAR_DYN'
SQP_TEST_SVR = OPEN_LOOP_SQP_PREFIX + 'shitty'
OPEN_LOOP_CONTROLLER = SQP_HOLD_OUT_SVR # SQP_NAIVE_LINEAR_DYN
